...
This file keeps the Nero-specific mjlab integration in new/ and leaves the
installed mjlab package untouched. It currently models only the robot tracking
...
DEFAULT_SCENE_PATH = MUJOCO_NERO_SCENE
DEFAULT_EEF_PATH = (
  "outputs/new_pipeline/ego_nero_easy/robot_eef_scene_camera_axis_corrected/"
  "robot_eef_trajectory.json"
)
DEFAULT_MINK_IK_PATH = "outputs/new_pipeline/ego_nero_easy/nero_eef_ik/nero_eef_ik.npz"
...
def log_stage(message: str) -> None:
  print(f"[rl_mjlab] {message}", flush=True)
